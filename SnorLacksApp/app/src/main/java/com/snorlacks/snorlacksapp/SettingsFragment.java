...
public class SettingsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String bulletOne = "1 • Turn on bluetooth (phone + vital jacket)";
        String bulletTwo = "2 • Search and select the vital jacket in the bluetooth devices list (top left corner)";
